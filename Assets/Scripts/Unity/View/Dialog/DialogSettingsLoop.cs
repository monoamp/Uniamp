...
{
	public class DialogSettingsLoop : AViewDrag
	{
		private ComponentSettingsLoop viewConfigLoopTool;
		
		public DialogSettingsLoop( ComponentSettingsLoop.CloseWindow aCloseWindow, Dictionary<string, string> aLanguage )
            : base( null, new Rect( 10.0f, 10.0f, Screen.width / 2.0f, Screen.height * 2.0f / 3.0f ) )
		{
			viewConfigLoopTool = new ComponentSettingsLoop( aCloseWindow, aLanguage );
		}
